...
def predict_test(train_data, train_cluster, test_data, test_cluster):
...
def cluster_images():
    ...
    train_cluster = cluster_train_data(train_data, 3) 
    test_cluster = cluster_test_data(test_data, 3)

    # Use linear regression to predict the clusters of test data and score the prediction
